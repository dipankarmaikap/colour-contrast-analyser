export default function Foreground() {
  ...
  return (
    <section className="foreground-colour bg-blue-600">
      <div className="p-2">
        <p className="text-xl text-white font-semibold">Foreground colour</p>
        <div className="control flex space-x-2 my-6">
          ...
          <input
            ...
            className="border border-dotted bg-transparent h-9 w-full sm:w-[340px] text-xl text-center
            focus:outline-none focus:bg-white focus:text-gray-900 focus:ring-4 ring-gray-700 font-medium text-white"
          />
        </div>
